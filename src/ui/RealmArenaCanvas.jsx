...
const REALM_CFG = {
  forest: {
    ...
    boss:{name:'Sylvara',hp:800,atk:16,color:'#2ecc71',size:28,x:15*TILE,y:5*TILE,
          icon:'🌿',chargeInterval:4.5,chargeTelegraph:0.9,chargeSpeed:420,chargeDist:280, xpReward:400,
          drops:[{item:'forest_essence',amount:1,chance:1.0},{item:'ore',amount:4,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:0.9}]},
  ...
  earth:{
    ...
    boss:{name:'Terran',hp:1500,atk:34,color:'#95a5a6',size:34,x:15*TILE,y:5*TILE,
          icon:'🪨',chargeInterval:4,chargeTelegraph:1.0,chargeSpeed:620,chargeDist:260, xpReward:600,
          drops:[{item:'earth_essence',amount:1,chance:1.0},{item:'stone',amount:8,chance:1.0},{item:'ore',amount:5,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
  ...
  wind:{
    ...
    boss:{name:'Zephyros',hp:1000,atk:20,color:'#87ceeb',size:28,x:15*TILE,y:5*TILE,
          icon:'💨',chargeInterval:3.0,chargeTelegraph:0.7,chargeSpeed:620,chargeDist:320, xpReward:400,
          drops:[{item:'wind_essence',amount:1,chance:1.0},{item:'ore',amount:4,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:0.9}]},
  ...
  fire:{
    ...
    boss:{name:'Ignar',hp:2100,atk:42,color:'#e74c3c',size:30,x:15*TILE,y:5*TILE,
          icon:'🔥',chargeInterval:1.8,chargeTelegraph:0.8,chargeSpeed:560,chargeDist:300, xpReward:600,
          drops:[{item:'fire_essence',amount:1,chance:1.0},{item:'fire_shard',amount:3,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
  ...
  ice:{
    ...
    boss:{name:'Glacius',hp:2800,atk:50,color:'#85c1e9',size:32,x:15*TILE,y:5*TILE,
          icon:'❄️',chargeInterval:3.0,chargeTelegraph:1.0,chargeSpeed:440,chargeDist:300, xpReward:900,
          drops:[{item:'ice_essence',amount:1,chance:1.0},{item:'ore',amount:6,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
  ...
  ocean:{
    ...
    boss:{name:'Nepthar',hp:3400,atk:58,color:'#1abc9c',size:30,x:15*TILE,y:5*TILE,
          icon:'🌊',chargeInterval:3.2,chargeTelegraph:0.9,chargeSpeed:520,chargeDist:290, xpReward:900,
          drops:[{item:'ocean_essence',amount:1,chance:1.0},{item:'ore',amount:6,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
  ...
  storm:{
    ...
    boss:{name:'Vortus',hp:4400,atk:70,color:'#9b59b6',size:32,x:15*TILE,y:5*TILE,
          icon:'⚡',chargeInterval:2.4,chargeTelegraph:0.7,chargeSpeed:720,chargeDist:330, xpReward:1200,
          drops:[{item:'storm_essence',amount:1,chance:1.0},{item:'fire_shard',amount:2,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
  ...
  shadow:{
    ...
    boss:{name:'Umbris',hp:5600,atk:82,color:'#8e44ad',size:34,x:15*TILE,y:5*TILE,
          icon:'🌑',chargeInterval:2.0,chargeTelegraph:0.8,chargeSpeed:540,chargeDist:300, xpReward:1200,
          drops:[{item:'shadow_essence',amount:1,chance:1.0},{item:'shadow_armor',amount:1,chance:0.7},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
  ...
  lava:{
    ...
    boss:{name:'Magmara',hp:7200,atk:95,color:'#e67e22',size:36,x:15*TILE,y:5*TILE,
          icon:'🌋',chargeInterval:3.2,chargeTelegraph:1.0,chargeSpeed:500,chargeDist:280, xpReward:1800,
          drops:[{item:'lava_essence',amount:1,chance:1.0},{item:'fire_shard',amount:5,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
  ...
  void:{
    ...
    boss:{name:'Nihilus',hp:11000,atk:115,color:'#f1c40f',size:38,x:15*TILE,y:5*TILE,
          icon:'✨',chargeInterval:2.4,chargeTelegraph:0.7,chargeSpeed:660,chargeDist:340, xpReward:2500,
          drops:[{item:'void_essence',amount:1,chance:1.0},{item:'fire_shard',amount:8,chance:1.0},{item:'shadow_armor',amount:1,chance:1.0},{item:'gear_drop_rare_weapon',amount:1,chance:1.0}]},
...
export default function RealmArenaCanvas({ realmId, onFlee }) {
  ...
  function update(dt){
    ...
    if(G.boss&&G.boss.alive&&!G.victory){
      ...
      // Boss checkpoints intentionally disabled: each realm entry starts a clean boss fight.
      } // end stun else
    }
